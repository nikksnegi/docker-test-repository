...
* The following dependency is not known to work with Spring Native: 'Spring Batch'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 dipanshu:0.0.1-SNAPSHOT
```
